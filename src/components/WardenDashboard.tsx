    ...
    <div className="min-h-screen bg-dark flex">
      ...
      <main className="flex-1 overflow-y-auto p-12 bg-dark">
        ...
        <header className="flex justify-between items-center mb-12">
          ...
          <div className="flex items-center gap-4">
            <div className="relative glass rounded-2xl p-3 flex items-center gap-3 w-64">
            ...
            <button className="w-12 h-12 glass rounded-2xl flex items-center justify-center relative">
